...
/*console.log('loading amplify');
const AmplifyCore = require('aws-amplify')
const Amplify = require('aws-amplify').default
const { Auth } = Amplify
const awsconfig = JSON.parse('../aws-exports');
...
$('#cognitoSignIn').click(function () {
    console.log('signing into Cognito');
