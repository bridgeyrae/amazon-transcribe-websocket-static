...
AWS.config.update({
  ...
  secretAccessKey: secretAccessKey: $('#secret_key').val(),
  region: region
});
var s3 = new aws.S3(Object.assign({accessKeyId: $('#access_id').val(), secretAccessKey: $('#secret_key').val()}));
...
let streamAudioToWebSocket = function (userMediaStream) {
    ...
    socket.onopen = function() {
        micStream.on('data', function(rawAudioChunk) {
            ...
            entireAudio.push(rawAudioChunk);
